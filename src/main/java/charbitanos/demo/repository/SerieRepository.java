...
public interface SerieRepository extends JpaRepository<Serie,Long> {
    ...
    @Query("SELECT e FROM Serie s JOIN s.temporadas t JOIN t.episodios e WHERE s.titulo ILIKE :nomeSerie AND YEAR(e.lancamento) >= :anoLancamento")
	List<Episodio> episodiosPorSerieEAno(String nomeSerie, int anoLancamento);
}
